---
title: ts-loader / babel-loader / esbuild-loader
date: October 15, 2022
---

최근 [모두모여라 프로젝트](https://www.moyeora.site/)를 진행하며 웹팩에 적용할 로더에 대해 많은 고민이 있었습니다.
...
- esbuild-loader 사용
- 개발 모드에서는 fork-ts-checker-webpack-plugin, 배포 모드에서는 tsc 사용
